...
%results_file_name = '/P4_FIT401_learn_always_freeze_off_res.csv';
...
% P1_AnomalyIdx = 6;
% P_plot2(P1,[1 11 6 10 8],P1_AnomalyIdx,anomalylikelihoodThreshold,PID); %LIT101
...
% P4_AnomalyIdx = 14;
% P_plot2(P4,[3 19 14 18 16],P4_AnomalyIdx,PID);
