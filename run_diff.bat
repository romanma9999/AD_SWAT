...
python calc_anomaly_stats.py -sn P2 -esn P2 -ft off -lt always -ofa _learn_diff -bcn AIT202,FIT201,MV201,P201,P203,P204,P205
...
python swat_htm.py --verbose -sn P3 -cn LIT301 -ctype 0 -ft off -lt always -diff
...
python calc_anomaly_stats.py -sn P3 -esn P3 -ft off -lt always -ofa _learn_diff -bcn DPIT301,FIT301,LIT301,MV301,MV302,MV303,MV304,P302

python swat_htm.py --verbose -sn P4 -cn AIT402 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P4 -cn FIT401 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P4 -cn LIT401 -ctype 0 -ft off -lt always -diff
...
python calc_anomaly_stats.py -sn P4 -esn P4 -ft off -lt always -ofa _learn_diff -bcn AIT402,FIT401,LIT401,P402,P403 

python swat_htm.py --verbose -sn P5 -cn AIT501 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P5 -cn AIT502 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P5 -cn AIT503 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P5 -cn AIT504 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P5 -cn FIT501 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P5 -cn FIT502 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P5 -cn FIT503 -ctype 0 -ft off -lt always -diff
...
python calc_anomaly_stats.py -sn P5 -esn P5 -ft off -lt always -ofa _learn_diff -bcn AIT501,AIT502,AIT503,AIT504,FIT501,FIT502,FIT503,FIT504,P501,PIT501,PIT503

python swat_htm.py --verbose -sn P6 -cn FIT601 -ctype 0 -ft off -lt always -diff
python swat_htm.py --verbose -sn P6 -cn P602 -ctype 1 -ft off -lt train_only --sdr_size 60
python calc_anomaly_stats.py -sn P6 -esn P6 -ft off -lt always -ofa _learn_diff -bcn FIT601,P602 