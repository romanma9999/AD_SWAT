...
python calc_anomaly_stats.py -sn P2 -esn P2 -ft off -lt always -ofa _learn_mixed -bcn AIT202,AIT203,FIT201,MV201,P203,P204,P205
...
python calc_anomaly_stats.py -sn P5 -esn P5 -ft off -lt always -ofa _learn_mixed -bcn AIT501,AIT502,AIT503,AIT504,FIT501,FIT503,FIT504,P501,PIT501,PIT502,PIT503
