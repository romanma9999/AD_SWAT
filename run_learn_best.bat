...
python calc_anomaly_stats.py -sn P1 -esn P1 -ft off -lt always -ofa _best -bcn LIT101,P102 

python swat_htm.py --verbose -sn P2 -cn AIT202 -ctype 0 -ft off -lt always -sbp -w 34 -size 1024
...
python calc_anomaly_stats.py -sn P2 -esn P2 -ft off -lt always -ofa _best -bcn AIT202,FIT201,MV201,P201,P203,P204,P205

python swat_htm.py --verbose -sn P3 -cn DPIT301 -ctype 0 -ft off -lt always 
python swat_htm.py --verbose -sn P3 -cn FIT301 -ctype 0 -ft off -lt always -sbp -w 21 -size 1024
...
python calc_anomaly_stats.py -sn P3 -esn P3 -ft off -lt always -ofa _best -bcn DPIT301,FIT301,LIT301,MV301,MV302,MV303,MV304,P302
...
python calc_anomaly_stats.py -sn P4 -esn P4 -ft off -lt always -ofa _best -bcn AIT402,FIT401,LIT401,P402,P403 
...
python swat_htm.py --verbose -sn P5 -cn FIT503 -ctype 0 -ft off -lt always -sbp -w 21 -size 1024
python swat_htm.py --verbose -sn P5 -cn FIT504 -ctype 0 -ft off -lt always -sbp -w 34 -size 1024
...
python calc_anomaly_stats.py -sn P5 -esn P5 -ft off -lt always -ofa _best -bcn AIT501,AIT502,AIT503,AIT504,FIT501,FIT502,FIT503,FIT504,P501,PIT501,PIT503
...
python calc_anomaly_stats.py -sn P6 -esn P6 -ft off -lt always -ofa _best -bcn FIT601,P602 